...
<html class="no-js" lang="">
  <head>
    ...
    <link
      rel="shortcut icon"
      type="image/x-icon"
      href="saaspal/assets/img/favicon.png"
    />
    <!-- Place favicon.ico in the root directory -->

    <!-- ======== CSS here ======== -->
    <link rel="stylesheet" href="saaspal/assets/css/bootstrap.min.css" />
    <link rel="stylesheet" href="saaspal/assets/css/lineicons.css" />
    <link rel="stylesheet" href="saaspal/assets/css/animate.css" />
    <link rel="stylesheet" href="saaspal/assets/css/main.css" />
  </head>
  <body>
    <!--[if lte IE 9]>
            ...
            <div class="col-lg-12">
              <nav class="navbar navbar-expand-lg">
                <a class="navbar-brand" href="index.html">
                  <img src="saaspal/assets/img/logo/logo.svg" alt="Logo" />
                </a>
                <button
        ...
        <div class="row align-items-center position-relative">
          ...
          <div class="col-lg-6">
            <div class="hero-img wow fadeInUp" data-wow-delay=".5s">
              <img src="saaspal/assets/img/hero/hero-img.png" alt="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-xl-6 col-lg-6">
            <div class="about-img">
              <img src="saaspal/assets/img/about/about-1.png" alt="" class="w-100" />
              <img
                src="saaspal/assets/img/about/about-left-shape.svg"
                alt=""
                class="shape shape-1"
              />
              <img
                src="saaspal/assets/img/about/left-dots.svg"
                alt=""
                class="shape shape-2"
              />
            </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-xl-6 col-lg-6 order-first order-lg-last">
            <div class="about-img-2">
              <img src="saaspal/assets/img/about/about-2.png" alt="" class="w-100" />
              <img
                src="saaspal/assets/img/about/about-right-shape.svg"
                alt=""
                class="shape shape-1"
              />
              <img
                src="saaspal/assets/img/about/right-dots.svg"
                alt=""
                class="shape shape-2"
              />
            </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
              <div class="footer-widget">
                <div class="logo mb-30">
                  <a href="index.html">
                    <img src="saaspal/assets/img/logo/logo.svg" alt="" />
                  </a>
                </div>
    ...
    <!-- ======== JS here ======== -->
    <script src="saaspal/assets/js/bootstrap.bundle.min.js"></script>
    <script src="saaspal/assets/js/wow.min.js"></script>
    <script src="saaspal/assets/js/main.js"></script>
  </body>
</html>
