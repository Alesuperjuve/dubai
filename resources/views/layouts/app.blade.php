        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>DUBAI</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('stiker') }}" class="nav-item nav-link"><i class="fa fa-solid fa-icons me-2"></i>Placard</a>

                    <a href="{{ route('toleransi') }}" class="nav-item nav-link"><i class="fa fa-solid fa-ruler me-2"></i>Detail</a>
                    
                    <a href="{{ route('pesawat') }}" class="nav-item nav-link"><i class="fa fa-solid fa-plane me-2"></i>Pesawat</a>
                    
                    <a href="{{ route('pegawai') }}" class="nav-item nav-link"><i class="fa fa-solid fa-user me-2"></i>Pegawai</a>
                    
                    <a href="{{ route('laporan') }}" class="nav-item nav-link"><i class="fa fa-solid fa-book me-2"></i></i>Laporan</a>
        ...
        <div class="content">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="#" class="dropdown-item">
                                <h6 class="fw-normal mb-0">Arabic</h6>
                                
                            </a>
                            <hr class="dropdown-divider">
                            <a href="#" class="dropdown-item">
                                <h6 class="fw-normal mb-0">Indonesia</h6>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Osep Teja</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">Profil</a>
                            <a href="#" class="dropdown-item">Konfigurasi</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded-top p-4">
                    ...
                    &copy; <a href="#">Dubai UAE BIZ</a>, All Right Reserved. 
                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->

                        </br>
                        Distributed By <a class="border-bottom" href="https://themewagon.com" target="_blank">Infiniferro Dubai</a>
                        </div>
                    </div>
                </div>
            </div>
